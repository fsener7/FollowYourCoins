...
import crypto.tracer.app.models.PricePoint;
import crypto.tracer.app.utils.Constants;
import crypto.tracer.app.utils.Injection;
import crypto.tracer.app.utils.TextUtils;
...
//        mChart.invalidate();
    ...
    private void setData(ArrayList<PricePoint> pricePoints) {
        ...
        DecimalFormat decimalFormat = new DecimalFormat(TextUtils.COIN_FORMAT);
        String latestPrice = decimalFormat.format(latestPoint.getClose());
        tvPrice.setText(getString(R.string.coin_symbol) + " " + latestPrice);
...
//            data.setValueTypeface(mTfLight);
    ...
    class MyYAxisValueFormatter implements IAxisValueFormatter {
        ...
        public MyYAxisValueFormatter() {
            mFormat = new DecimalFormat(TextUtils.COIN_FORMAT_ROUNDED_OFF);
        }
